...
const CursoInicial = () => {
  ...
  return (
    <Layout>
      <SEO 
        title="Guía de Vibe Coding Nivel Inicial"
        description="Aprende los fundamentos para crear tu primera aplicación con IA. Desde cero hasta tu primer deploy."
        canonical="/guias-cursos-vibe-coding/inicial"
      />
