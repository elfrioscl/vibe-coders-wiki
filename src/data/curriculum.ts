...
const modulosIniciales: Module[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { title: "MLP vs MVP", description: "Minimum Lovable Product: no solo viable, sino que enamore desde el inicio" },
...
const modulosAvanzados: Module[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { title: "SEO Programático (PLSEO)", description: "Crear páginas automáticas que atacan keywords específicas (comparadores, directorios)" },
